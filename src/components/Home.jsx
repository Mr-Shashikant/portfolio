...
import inkImg from "../assets/ink.gif"
...
function Home() {
    ...
    return (
        <section id="home" className="pt-25 bg-top bg-cover bg-no-repeat flex flex-col items-center min-h-screen" style={{ backgroundImage: `url(${bgImage})` }}>
            ...
            <img src={heroImage} alt="Hero bg image" className="h-100 rounded-lg grayscale hover:grayscale-0 transition-all duration-300 mt-5 mb-2" style={{maskImage: `url(${inkImg})`, maskPosition: "center", maskSize: "cover"}} />
            ...
            <div className="flex justify-center items-center gap-6">
                ...
                <button className="underline cursor-pointer hover:no-underline hover:drop-shadow-[0_0_5px_rgba(255,255,255,0.25)]"><a href="#about">Know more</a></button>
            </div>
        </section>
    )
}
