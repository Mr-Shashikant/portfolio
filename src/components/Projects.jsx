        ...
        <div className="flex flex-col justify-center items-center gap-5 max-w-200 bg-[#0a1428] hover:bg-[#081020] rounded-xl hover:-translate-y-2 hover:shadow-emerald-300/2 hover:shadow-xl transition-all duration-300">
            ...
            <div className="px-5">
                ...
                <div className="flex justify-self-start items-center gap-2 mt-5 mb-5">
                    ...
                    <a href={props.live} target="_blank" aria-label="Live Preview link" className="h-10 w-10 rounded-full flex justify-center items-center p-1 border text-emerald-300 opacity-70 hover:opacity-100 cursor-pointer"><svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
